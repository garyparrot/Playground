...
int main(int argc, const char* args[]){
    ...
    int array[] = {1,2,3};
    // WARNING: next_permutation is stateless.
    //          keep array in-order if you want to get the full permutation
    //          next_permutation won't spawn same state twice, great.
    do{
        cout << to_string_array3(array, array+3, "Perm: ") << endl;
